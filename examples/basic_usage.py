...
from scipreprocess import preprocess_file, preprocess_documents, PipelineConfig
...
def example_custom_config():
    ...
    results = pipeline.preprocess_documents([
        "examples/test_files/paper1.pdf",
        "examples/test_files/paper2.pdf"
    ])
...
def example_validate_output():
    ...
    try:
        from validate_output import validate_output, OutputValidator
